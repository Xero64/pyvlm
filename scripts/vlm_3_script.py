...
axd = lres_org.plot_trefftz_drag_force_distribution()
...
axl = None
axl = lres_0deg.plot_trefftz_lift_force_distribution(ax=axl)
axl = lres_6deg.plot_trefftz_lift_force_distribution(ax=axl)
_ = axl.set_ylabel('Lift Distribution')
_ = axl.set_xlabel('Span Position')
...
axd = None
axd = lres_0deg.plot_trefftz_drag_force_distribution(ax=axd)
axd = lres_6deg.plot_trefftz_drag_force_distribution(ax=axd)
_ = axd.set_ylabel('Drag Distribution')
_ = axd.set_xlabel('Span Position')
